...
const loadRender = async function(page, hash = "article") {
    ...
    _modelJs.state.page = page;
    if (page === "article") {
        const html = await _modelJs.loadArticle();
        (0, _articleViewJsDefault.default).render(html);
        (0, _articleViewJsDefault.default).initToggle();
        (0, _articleViewJsDefault.default)._container.scrollTop = 0;
    }
    if (page === "dashboard") {
        let html = await _modelJs.loadDashboard();
        if (_modelJs.state.page !== "dashboard") return;
        (0, _dashboardViewJsDefault.default).render(html);
        const initDashUI = ()=>{
            if (_modelJs.state.page !== "dashboard") return;
            const scrollPos = (0, _dashboardViewJsDefault.default)._container.scrollTop;
            (0, _dashboardViewJsDefault.default).buildHtml(_modelJs.state, html);
            (0, _dashboardViewJsDefault.default).initButtons(refreshHandler, showAllHandler); // ← uses handlers below
            requestAnimationFrame(()=>{
                (0, _dashboardViewJsDefault.default)._container.scrollTop = scrollPos;
            });
        };
        const refreshHandler = async ()=>{
            try {
                ...
                await _modelJs.loadResponse(true);
                if (_modelJs.state.page !== "dashboard") return;
                initDashUI();
            // main.js inside refreshHandler catch block
                ...
                if (status) {
                    status.style.display = "inline";
                    status.innerHTML = `&ensp;&ensp;Update failed. ${_modelJs.state.timestamp === null || _modelJs.state.timestamp === undefined || _modelJs.state.timestamp === "" ? "No old data found." : `Showing data from ${new Date(_modelJs.state.timestamp).toLocaleDateString("en-US", {
                        month: "short",
                        day: "numeric",
                        year: "numeric",
                        hour: "numeric",
        ...
        const refresh_btn = document.querySelector(".dash--refresh");
        if (_modelJs.state.response.length === 0 && refresh_btn) refresh_btn.classList.add("dash--refresh--active");
        try {
            await _modelJs.loadResponse();
            if (_modelJs.state.page !== "dashboard") return;
            ...
            (0, _dashboardViewJsDefault.default).initButtons(refreshHandler, showAllHandler);
            console.error("CPE Dashboard Error:", err.message);
        }
    }
    return true;
...
const init = async function() {
    (0, _articleViewJsDefault.default)._addHandlerRender(loadRender);
    (0, _dashboardViewJsDefault.default)._addHandlerRender(loadRender);
    (0, _navJsDefault.default)._addHandlerNavBtn();
};
init();

},{"./api.js":"fi3qz","./config.js":"9oMLC","./views/nav.js":"l5zDO","./views/articleView.js":"7srs2","./views/dashboardView.js":"9xdrW","./model.js":"kTBnY","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fi3qz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const getJSON = async function(url, signal = null) {
    try {
        const res = await Promise.race([
            ...
            timeout((0, _config.API_TIMEOUT_SEC))
        ]);
...
},{"./config":"9oMLC","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9oMLC":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_URL", ()=>API_URL);
parcelHelpers.export(exports, "API_TIMEOUT_SEC", ()=>API_TIMEOUT_SEC);
parcelHelpers.export(exports, "PAGES", ()=>PAGES);
const API_URL = "https://script.google.com/a/*/macros/s/AKfycbzJlEeDFIrRGwTUbk6BPuAns4VVbcJGSCReSRmvm5CTpk9wABtrd6cuho6oKIjmiXKj/exec";
...
},{}],"l5zDO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class nav {
    ...
    _renderNavBtn(page) {
        this._navBtnArr.forEach((btn)=>{
            ...
            if (page === btn.innerHTML.toLowerCase().trim()) btn.classList.add("nav--focus");
        });
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7srs2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("./views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
class articleView extends (0, _viewsJsDefault.default) {
    _page = "article";
  ...
  `;
    ...
    _addHandlerScroll() {
        this._list.addEventListener("click", (e)=>{
            ...
            const targetId = Array.from(btn.classList).find((cls)=>cls.startsWith("sec--"));
    ...
    _updateBtnFocus(activeBtn) {
        this._list.querySelectorAll(".content--btn").forEach((btn)=>btn.classList.remove("content--btn--focus"));
...
},{"./views.js":"aDirB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aDirB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
    ...
    _addHandlerRender(handler) {
        ...
        [
            ...
            window.addEventListener(ev, ()=>{
                ...
                if (!hash || !(0, _config.PAGES).some((page)=>page === hash)) {
                    //console.log("INVALID HASH");
                    hash = "article";
                    window.location.hash = hash;
                }
                const renderFlag = handler(page, hash);
                if (renderFlag) (0, _navJsDefault.default)._renderNavBtn(hash);
...
},{"../config":"9oMLC","./nav.js":"l5zDO","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9xdrW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("./views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
...
class dashboardView extends (0, _viewsJsDefault.default) {
    _page = "dashboard";
    _data;
    _html;
    _show_all = false;
    ...
    _render_response(raw, show_all = false) {
        ...
        raw = raw.filter((res)=>res !== null && res !== undefined && res !== "" && res !== " ");
    ...
    _renderCharts(data) {
        this._interesting_q.forEach((q)=>{
            ...
            if (qIndex === -1) return;
            const responses = data.response.map((res)=>res[qIndex]).filter((val)=>val);
            ...
            const isCrowded = labels.some((label)=>isNaN(parseInt(label)) && label.length > 3);
    ...
    _renderResult(data, markupText) {
        ...
        this._interesting_q.forEach((q)=>{
            ...
            canvas_container.style.cssText = "position: relative; height:200px; width:100%; margin-top: 1rem;";
            ...
            pie_desc.innerText = `\u{E02}\u{E49}\u{E2D} ${q} (\u{E04}\u{E33}\u{E16}\u{E32}\u{E21}\u{E17}\u{E35}\u{E48} ${qIndex} \u{E08}\u{E32}\u{E01}\u{E17}\u{E31}\u{E49}\u{E07}\u{E2B}\u{E21}\u{E14} ${q_count} \u{E04}\u{E33}\u{E16}\u{E32}\u{E21})`;
        ...
        this._open_ended.forEach((q)=>{
            ...
            this._dash_grid_anonymous.insertAdjacentElement("beforeend", ano_container);
        });
        ...
        status.innerHTML = flag ? "&ensp;&ensp;Data updated successfully!" : "&ensp;&ensp;Data failed to fetch. Please try again later.";
    ...
    initButtons(refreshHandler, showAllHandler) {
        ...
        if (refresh_btn) refresh_btn.addEventListener("click", ()=>{
...
},{"./views.js":"aDirB","chart.js/auto":"a3bOj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"a3bOj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kTBnY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadResponse", ()=>loadResponse);
parcelHelpers.export(exports, "loadArticle", ()=>loadArticle);
parcelHelpers.export(exports, "loadDashboard", ()=>loadDashboard);
var _apiJs = require("./api.js");
var _configJs = require("./config.js");
var _articleHtml = require("url:../content/article.html");
var _articleHtmlDefault = parcelHelpers.interopDefault(_articleHtml);
var _dashboardHtml = require("url:../content/dashboard.html");
var _dashboardHtmlDefault = parcelHelpers.interopDefault(_dashboardHtml);
let _controller;
const state = {
    page: "article",
    timestamp: "",
 ...
 */ const createObject = function(q, i, type, entry) {
    // Timestamp handler
    if (i == 0) entry["timestamp"] = q[1] === "" ? null : type === 0 ? createTimeObject(q[1]) : q[0];
    // Normal questions handler
    entry[`${i}`] = q[1] === "" ? null : type === 0 ? q[1] : {
...
const _calculateGlobalRate = function() {
    ...
    const questionKeys = Object.keys(state.questions).filter((key)=>key !== "timestamp");
    ...
    const totalAnswers = state.response.reduce((acc, res)=>{
        const answeredInRow = questionKeys.filter((key)=>res[key] !== null && res[key] !== "").length;
        return acc + answeredInRow;
    }, 0);
    // 3) Calculate percentage
    return (totalAnswers / (totalQuestions * totalRespondents) * 100).toFixed(2);
};
const loadResponse = async function(forceRefresh = false) {
    try {
        ...
        const res = await (0, _apiJs.getJSON)((0, _configJs.API_URL), _controller.signal);
...
const loadArticle = async function() {
    try {
        const res = await fetch((0, _articleHtmlDefault.default));
        return await res.text();
    } catch (err) {
        console.error(err.message);
    }
...
const loadDashboard = async function() {
    try {
        const res = await fetch((0, _dashboardHtmlDefault.default));
        return await res.text();
    } catch (err) {
        console.error(err.message);
    }
...
},{"./api.js":"fi3qz","./config.js":"9oMLC","url:../content/article.html":"cGeLU","url:../content/dashboard.html":"4uxsl","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cGeLU":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("article.902d8111.html") + "?" + Date.now();

},{}],"4uxsl":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("dashboard.50dc8795.html") + "?" + Date.now();

},{}]},["9qRpS","1D1Xv"], "1D1Xv", "parcelRequire47f8", {}, "./", "/")

//# sourceMappingURL=GEN111_DumbWeb.a16d0fb5.js.map
